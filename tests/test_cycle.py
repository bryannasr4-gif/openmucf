...
def test_wsn_norm_excludes_loss_accumulators_bit_exact():
    ...
    to the v1 reference BIT-FOR-BIT (the reduction gate, at PURE atol 1e-9, rtol=0); reverting to
    ...
    # The reduction gate as PURE atol (rtol=0): only the v1-sliced norm passes (default 8-norm -> ~5e-9).
