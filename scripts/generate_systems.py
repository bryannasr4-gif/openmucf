...
Content: the full differentiable energy-balance graph as a "Q
...
Framing: no new physics and no evaluation -- this is a transparent ACCOUNTING instrument over the frozen v1
...
# Pre-registered G-Kelly band: reproduce Kelly's 14% within +/-10% relative.
...
> **A transparent accounting instrument, NOT new physics and NOT an evaluation.**
...
**Finding (reported, not tuned).** {H['kelly_q_elec_pct']}% is **just above** the pre-registered
