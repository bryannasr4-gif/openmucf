...
Content: the inverse-design mode -- "what would have to be true".
...
# The frontier grid: X_mu targets and the cycling-rate columns. 1.45e8 = measured liquid max;
...
> **INVERSE-DESIGN, NOT A VERDICT.** This is the requirement form of the same forward physics used
