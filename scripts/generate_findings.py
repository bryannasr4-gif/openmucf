...
# Section 2 says the Jones 1986 average and the Kou-Chen best case both lie ABOVE this box, and that
# each needs an effective sticking BELOW its support. Both claims are read from the data and pinned
# here:
...
assert _JONES_NEEDS_OSE < _OSE_SUPPORT_LO and _KOU_OSE < _OSE_SUPPORT_LO, (
    "the section-2 sentence says both the Jones 1986 average and the Kou-Chen best case need an "
    "effective "
...
axes[0].axvline(150, color="green", ls="--", label="Jones 1986 average ~150 (liquefied d-t, c_t=0.3)")
