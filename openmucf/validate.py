...
def report_markdown(results, channels="off") -> str:
    ...
    lines += [
        ...
        "editorial: every row above, the one deferred row aside, tests the kinetics engine or its "
        "formation and sticking sub-models, whereas those rows compare two closed forms and pass "
        "unchanged when the engine is broken "
