...
contraction under constant-R: **C4 > C3 > C1 > C2**; under R(phi)-inflated: **C4 > C3 > C2 > C1**. Contraction
...
disappearance slope C1 contracts R by 0.070 under constant-R but collapses to 0.002 under
...
is **statistically indistinguishable from the R-independent control C2** (0.017): the nominal
ranking reads constant-R C4 > C3 > C1 > C2 vs R(phi)-inflated C4 > C3 > C2 > C1, but that C1<->C2 crossing is
itself WITHIN the +/-3 pp noise floor and is NOT a robust ordering -- the robust finding is C1's collapse,
not the crossing. C4's contraction (0.408) does not move between classes: it constrains omega_s0
